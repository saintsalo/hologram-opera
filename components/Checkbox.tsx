...
const Checkbox = ({ color = "orange", size = "sm", className }: CheckBoxType) => {
      ...
      <label>
        <input
          ...
          className={classNames(
            ...
            {
              "before:bg-violet-200 before:checked:bg-violet-300": color === "violet",
            },
            {
            ...
            {
              "before:bg-orange-200 before:checked:bg-orange-300": color === "orange",
            },
            {
              "before:bg-yellow-200 before:checked:bg-yellow-300": color === "yellow",
            },
            {
