...
const Input = ({ placeholder, focusColor = "pink", rounded = "none", className }: InputType) => {
  const [value, setValue] = useState("")
  return (
    <input
      className={classNames(
        "w-72 md:w-full max-w-md border-black transition-all border-2 p-2.5 focus:outline-none focus:shadow-[2px_2px_0px_rgba(0,0,0,1)] focus:bg-[#FFA6F6] focus:placeholder:text-slate-500 active:shadow-[2px_2px_0px_rgba(0,0,0,1)]",
